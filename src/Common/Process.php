...
use Wslim\Common\Pipe\Pipes;
use Wslim\Common\Pipe\WindowsPipes;
use Wslim\Common\Pipe\UnixPipes;
    ...
    public function start($callback = null)
    {
        ...
        if ('\\' === DIRECTORY_SEPARATOR && $this->enhanceWindowsCompatibility) {
            ...
            foreach ($this->processPipes->getFiles() as $offset => $filename) {
                $commandline .= ' ' . $offset . '>' . static::escapeArgument($filename);
            }
            $commandline .= '"';
    ...
    public function setInput($input)
{
        ...
        $this->input = static::validateInput(sprintf('%s::%s', __CLASS__, __FUNCTION__), $input);
