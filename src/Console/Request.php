...
class Request implements RequestInterface
{
	...
	/**
	 * 
	 * @param array $serverPamams
	 */
	public function __construct($serverPamams = null)
	{   
	    $argv = $serverPamams['argv'];
	    // 去除命令名
	    array_shift($argv);
	    
	    $this->withArguments($argv);
	}
	
	public function withArguments($argv=null)
	{
	    if (null === $argv) {
	        $argv = $_SERVER['argv'];
	        // 去除命令名
	...
	public function validate()
	{
	    if (count($this->arguments) < $this->definition->getArgumentRequiredCount()) {
	        throw new \RuntimeException(__METHOD__ . ': Not enough arguments, please use [-h].');
	    }
	}
	...
	/**
	 * {@inheritDoc}
	 * @see \Wslim\Common\RequestInterface::getMethod()
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see \Wslim\Common\RequestInterface::detectContentType()
	 */
	...
	/**
	 * {@inheritDoc}
	 * @see \Wslim\Common\RequestInterface::input()
	 */
	public function input($key=null, $default=null)
	{
	    if ($key && $key !== '*') {
	        return isset($_SERVER['argv'][$key]) ? $_SERVER['argv'][$key] : $default;
	    } else {
	        return isset($_SERVER['argv']) ? $_SERVER['argv'] : [];
	    }
	}
